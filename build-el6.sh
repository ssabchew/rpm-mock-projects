...
DIST='el6'
MOCKCFG="epel-6-$ARCH"
REPO_SSH='root@repo.bellstack.com'
REPO_SSH_DIR='/srv/www/repo.bellstack.com/bstk-common/centos/6'
...
ssh "$REPO_SSH" "cd /srv/www/repo.bellstack.com/bstk-common; ./mkrepo-$DIST.sh"
